...
using WebSiteComparer.Core.ImageProcessing.Implementation;
using WebSiteComparer.Core.ImageProcessing.Implementation.Extensions;
using WebSiteComparer.Core.ImageProcessing.Implementation.Utils;

namespace WebSiteComparer.Core.ImageProcessing.Models
{
